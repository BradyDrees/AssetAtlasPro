...
export default function UnitError({
  ...
  // Pattern: /inspections/{projectId}/sections/{sectionId}/units/{unitId}
  ...
  const unitIdx = segments.indexOf("units");
  const unitId = unitIdx >= 0 ? segments[unitIdx + 1] : "";
