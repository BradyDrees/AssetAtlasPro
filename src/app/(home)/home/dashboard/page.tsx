      ...
      <div className="grid grid-cols-4 gap-3">
        ...
        {showPoolExplainer ? (
          <Link
            ...
            className="bg-surface-primary rounded-xl border border-edge-primary p-4 text-center hover:border-rose-500/30 transition-colors group"
          >
            {/* Piggy bank icon */}
            <div className="flex justify-center mb-1">
              <svg
                className="w-6 h-6 text-rose-400 group-hover:text-rose-300 transition-colors"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                strokeWidth={1.5}
