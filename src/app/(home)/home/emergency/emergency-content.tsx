      ...
      <div className="space-y-4">
        ...
        {needsSafetyAck && (
          <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
            ...
            <a
              href="tel:911"
              className="inline-flex items-center gap-2 mb-3 px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white text-sm font-bold rounded-lg transition-colors min-h-[44px]"
            >
