  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 text-sm text-content-quaternary mb-4">
        ...
        <span>/</span>
        <Link
          href={`/vendor/inspections/${projectId}?group=${groupSlug}`}
          className="hover:text-amber-600 transition-colors"
        >
          {project.name}
        </Link>
        <span>/</span>
        <Link
          href={`/vendor/inspections/${projectId}/sections/${projectSectionId}`}
          className="hover:text-amber-600 transition-colors"
        >
      ...
      {(prevUnit || nextUnit) && (
        <div className="mt-6 flex items-center justify-between">
          {prevUnit ? (
            <Link
              href={`/vendor/inspections/${projectId}/sections/${projectSectionId}/units/${prevUnit.id}`}
          ...
          {nextUnit ? (
            <Link
              href={`/vendor/inspections/${projectId}/sections/${projectSectionId}/units/${nextUnit.id}`}
