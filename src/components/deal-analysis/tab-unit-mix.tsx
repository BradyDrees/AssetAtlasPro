            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-edge-secondary">
                  <th className="text-left py-2 px-2 text-content-muted font-medium">{t("unitMixHeaders.type")}</th>
                  <th className="text-right py-2 px-2 text-content-muted font-medium">{t("unitMixHeaders.sf")}</th>
                  <th className="text-right py-2 px-2 text-content-muted font-medium">{t("unitMixHeaders.count")}</th>
                  <th className="text-right py-2 px-2 text-content-muted font-medium">{t("unitMixHeaders.currentRent")}</th>
                  <th className="text-right py-2 px-2 text-content-muted font-medium">{t("unitMixHeaders.marketRent")}</th>
                  <th className="text-right py-2 px-2 text-content-muted font-medium">{t("unitMixHeaders.monthly")}</th>
                  <th className="text-right py-2 px-2 text-content-muted font-medium">{t("unitMixHeaders.annual")}</th>
                  <th className="text-right py-2 px-2 text-content-muted font-medium">{t("unitMixHeaders.upside")}</th>
                  <th className="w-8"></th>
                </tr>
              </thead>
              <tbody>
                {d.unitMix.map((row, i) => {
                  ...
                  return (
                    <tr key={i} className="border-b border-edge-tertiary">
                      ...
                      <td className="py-1 px-1">
                        <input
                          className="w-16 px-2 py-1 text-xs text-right bg-surface-secondary border border-edge-secondary rounded font-mono text-content-primary"
                          value={row.sf || ""}
                      ...
                      <td className="text-right px-2 font-mono text-content-secondary">{fmt(monthly)}</td>
                      <td className="text-right px-2 font-mono text-content-secondary">{fmt(annual)}</td>
                      <td className="text-right px-2 font-mono text-brand-400">{fmt(upside)}</td>
                      <td className="px-1">
                        <button
                          onClick={() => removeRow(i)}
              ...
              <tfoot>
                <tr className="border-t-2 border-edge-secondary font-semibold">
                  <td className="py-2 px-2 text-content-primary">{t("unitMixHeaders.totals")}</td>
                  <td className="text-right px-2 font-mono text-content-primary">{fmt(calc.unitMixAvgSF, "num")}</td>
                  <td className="text-right px-2 font-mono text-content-primary">{calc.unitMixTotalUnits}</td>
                  <td></td>
                  <td></td>
                  <td className="text-right px-2 font-mono text-content-primary">{fmt(calc.unitMixMonthlyIncome)}</td>
                  <td className="text-right px-2 font-mono text-content-primary">{fmt(calc.unitMixAnnualIncome)}</td>
                  <td className="text-right px-2 font-mono text-brand-400">{fmt(calc.unitMixTotalUpside)}</td>
                  <td></td>
                </tr>
              </tfoot>
            </table>
