...
export default async function InspectionsPage() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6 bg-[radial-gradient(ellipse_at_top_left,_var(--color-amber-900)_0%,_transparent_50%),radial-gradient(ellipse_at_bottom_right,_var(--color-amber-900)_0%,_var(--charcoal-950)_60%)] bg-charcoal-900 -mx-4 -mt-4 md:-mx-6 md:-mt-6 px-4 py-5 md:px-6 rounded-b-xl">
        <div>
        ...
        <CreateInspectionButton tier="vendor" />
      </div>
