...
export function NotificationBell({ namespace = "vendor.nav" }: NotificationBellProps) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute left-0 top-full mt-2 w-80 max-w-[calc(100vw-2rem)] max-h-96 overflow-y-auto bg-surface-primary rounded-xl border border-edge-primary shadow-lg z-[60]">
