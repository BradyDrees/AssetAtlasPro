          ...
          {loadingVendors ? (
            ...
            <>
              <select
                ...
                className={`w-full p-3 bg-surface-secondary border rounded-lg text-sm text-content-primary focus:outline-none focus:ring-2 focus:ring-green-500/40 ${formErrors.vendor ? "border-red-500" : "border-edge-primary"}`}
              >
        ...
        <div className="bg-surface-primary rounded-xl border border-edge-primary p-5 space-y-4">
          ...
          <div>
            <select
              ...
              className={`w-full p-3 bg-surface-secondary border rounded-lg text-sm text-content-primary focus:outline-none focus:ring-2 focus:ring-green-500/40 ${formErrors.trade ? "border-red-500" : "border-edge-primary"}`}
            >
          ...
          <div>
            <textarea
              ...
              rows={3}
              className={`w-full p-3 bg-surface-secondary border rounded-lg text-sm text-content-primary placeholder:text-content-quaternary focus:outline-none focus:ring-2 focus:ring-green-500/40 ${formErrors.description ? "border-red-500" : "border-edge-primary"}`}
            />
