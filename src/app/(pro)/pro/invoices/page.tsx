    ...
    <div className="max-w-6xl mx-auto space-y-4">
      ...
      {loading ? (
        ...
        <div className="bg-surface-primary rounded-xl border border-edge-primary p-8 text-center">
          ...
          {tab === "pipeline" && (
            <Link href="/pro/invoices/new" className="inline-flex items-center gap-1.5 mt-3 text-sm text-brand-400 hover:text-brand-300 transition-colors">
              {t("createFirst")}
            </Link>
          )}
        </div>
