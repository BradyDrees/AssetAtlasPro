  ...
  const navItems = isTech
    ...
    : isOfficeMgr
      ...
      : [
          ...
          { href: "/vendor/pricebook", label: vt("pricebook"), icon: <PricebookIcon />, matchExact: false },
          { href: "/vendor/templates", label: vt("templates"), icon: <TemplatesIcon />, matchExact: false },
          { href: "/vendor/invoices", label: vt("invoices"), icon: <ReceiptIcon />, matchExact: false },
          { href: "/vendor/recurring", label: vt("recurring"), icon: <ReceiptIcon />, matchExact: false },
        ...
        >
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="hidden md:flex items-center justify-center p-2.5 min-w-[44px] min-h-[44px] text-charcoal-400 hover:text-white hover:bg-charcoal-700 rounded transition-colors"
          ...
          <button
            onClick={() => setIsOpen(false)}
            className="md:hidden p-2.5 min-w-[44px] min-h-[44px] text-charcoal-400 hover:text-white flex items-center justify-center"
