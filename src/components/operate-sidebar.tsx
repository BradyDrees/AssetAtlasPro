...
export function OperateSidebar({ user, hasVendorRole = false, hasOwnerRole = false }: OperateSidebarProps) {
  ...
  const navItems = [
    ...
    { href: "/operate/units", label: t("nav.units") ?? "Units", matchPaths: ["/operate/units"], icon: (
      <svg className={ic} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5M3.75 3v18m4.5-18v18m4.5-18v18m4.5-18v18M6.75 21V8.25m4.5 0V21m4.5-12.75V21" />
      </svg>
    )},
    ...
    { href: "/operate/projects", label: t("nav.projects") ?? "Projects", matchPaths: ["/operate/projects"], icon: (
      <svg className={ic} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    { href: "/operate/vendors", label: t("nav.vendors"), matchPaths: ["/operate/vendors", "/operate/vendors/directory"], icon: (
      <svg className={ic} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    { href: "/operate/inbox", label: t("nav.messages"), matchPaths: ["/operate/inbox"], showUnreadBadge: true, icon: (
      <svg className={ic} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
